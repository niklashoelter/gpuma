...
To use ORB-v3 models instead of Fairchem UMA, install the optional `orb` extra:

```bash
pip install gpuma[orb]
```

Then set `"model_type": "orb"` in your configuration file (see [Configuration](config.md)).
